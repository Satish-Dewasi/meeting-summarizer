...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#07070b] px-4 py-6">
      <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-310 flex-col overflow-hidden rounded-2xl border border-[#0f3a3a] bg-gradient-to-b from-[#0d0d15] to-[#09090e] px-6 py-10 shadow-[0_0_80px_rgba(34,211,200,0.08)] md:px-12">
        <svg
          viewBox="0 0 100 100"
        ...
        >
          <path
            ...
            strokeWidth="1"
          />
          <path d="M0 60 Q20 75 35 50" stroke="#22D3C8" strokeWidth="0.7" />
        </svg>
        <svg
          viewBox="0 0 100 100"
